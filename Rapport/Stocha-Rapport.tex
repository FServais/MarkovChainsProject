...
\begin{figure}[h]
	\center
	\subfigure{\includegraphics[scale=0.45]{../images/Q2.jpg}}
	\subfigure{\includegraphics[scale=0.45]{../images/Q3.jpg}}
...
\begin{figure}[h]
	\center
	\subfigure{\includegraphics[scale=0.45]{../images/evolPagerank.png}\label{sfig:evolPageRankAlpha}}
	\subfigure{\includegraphics[scale=0.45]{../images/nbItAlpha.png}\label{sfig:nbItAlph}}
...
\begin{figure}[h]
	\center
	\subfigure[{\textit{add-$\lambda$ smoothing} : $\lambda = 1$}]{\includegraphics[scale=0.45]{../images/evol_m_bias_AK1_E.png}}
	\subfigure[{\textit{add-$\lambda$ smoothing} : $\lambda = 0.06$}]{\includegraphics[scale=0.45]{../images/evol_m_bias_AK006_E.png}}
...
Pour définir l'appartenance d'une trace à l'un des deux modèles, nous estimons la valeur de $\alpha$ de la trace grâce à la méthode décrite au premier point et nous considérons que la trace appartient au surfeur ayant un $\alpha_i$ le plus proche.
...
\end{table}
 Si on compare avec le tableau \ref{tab:surf_trace}, on remarque que 4 estimations diffèrent : celles pour les traces 1, 3, 17 et 18. Au vu des résultats des tests de nos méthodes, nous aurions plus tendance à choisir l'estimation à partir de
